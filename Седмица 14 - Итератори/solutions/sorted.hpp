...
public:
  ...
  class ForwardIterator {
    public:
      ForwardIterator(T* element) : element(element) {}

      ForwardIterator& operator++() {
        return *this = ForwardIterator(element + 1);
      }
  ...
  class ReverseIterator {
    public:
      ReverseIterator(T* element) : element(element) {}

      ReverseIterator& operator++() {
        return *this = ReverseIterator(element - 1);
      }
  ...
  ForwardIterator end() const {
    return ForwardIterator(data + size);
  }
